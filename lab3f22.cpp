...
//
//Build:
//  gcc lab3f22.c -Wall -lssl -lcrypto
//  
//Usage:
//  ./lab3f22 <host> <page>
//
...
//
//For the assignment:
//  This program source code must be refactored into a C++ program, and be
//  formatted with perfect K&R style for bracing, spacing, and indenting.
//  Other element of good program style must be implemented.
//
//
//
#include <stdio.h>
...
int main(int argc, char *argv[])
{
	...
	//SSL_MOrdDE_AUTO_RETRY flag of the SSL_CTX_set_mode call.
    ...
    // ========================================================
    // Fixed Warning : this 'if claused does not guard...
    // Previous code was :
    //      if (ret <= 0)
    // ========================================================
	if (ret <= 0) {
	...
	//
	//The request was sent, not the data is read...
...
void read_the_page(SSL *ssl)
{
    ...
    char buf[256];
	// ===================================================
	// Fixed warning : unused variable 'ret' 
	// Previous code was: 
	//     int ret;
	// ===================================================
	//int ret;
